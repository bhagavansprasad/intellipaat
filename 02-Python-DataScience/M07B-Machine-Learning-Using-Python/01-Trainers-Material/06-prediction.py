...
def calc_variance_inflation_factor(X_train):
    ...
    # print(len(X_train.values), X_train.values)
    ...
    print(vif.to_dict('dict'))
    dlist = vif.to_dict('list')
    print(dlist['Features'])
    print(dlist['VIF'])
    # print(tabulate([dlist['VIF']], dlist['Features'], "fancy_grid"))
    print(tabulate([dlist['VIF']], dlist['Features']))
...
def best_fit_line():
    ...
    calc_variance_inflation_factor(X_train)

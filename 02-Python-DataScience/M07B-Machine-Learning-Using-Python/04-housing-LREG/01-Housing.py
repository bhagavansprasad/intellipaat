...
def encode_yes_no(df, features_list):
...
def feature_engineering(df):
    features_list =  ['mainroad', 'guestroom', 'basement', 'hotwaterheating', 'airconditioning', 'prefarea']
    encode_yes_no(df, features_list)
    
    indicator_features = ['furnishingstatus']
    for feature in indicator_features:    
        df = categorical_to_indicator(df, feature)
    
    features_list = ['semi-furnished', 'unfurnished']
